...
\begin{frame}
  ...
  \item Support more scenarios
    % The original FELICS scenarios have been removed (only 16B plaintext + 16B AD is supported right now); felics-run could learn to set input sizes before compiling.
