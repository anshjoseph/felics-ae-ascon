...
do
	...
	cipher_block_size=$(echo $cipher_directory_name | cut -d $DIRECTORY_NAME_SEPARATOR -f 2)
	cipher_key_size=$(echo $cipher_directory_name | cut -d $DIRECTORY_NAME_SEPARATOR -f 3)
	cipher_implementation_version=$(echo $cipher_directory_name | cut -d $DIRECTORY_NAME_SEPARATOR -f 4)
	...
	case $SCRIPT_FORMAT in
		$SCRIPT_FORMAT_0)
			add_raw_table_row $script_raw_output "$cipher_name" "$cipher_block_size" "$cipher_key_size" "$cipher_implementation_version" "$cipher_implementation_info" "$cipher_implementation_authors"
			add_mediawiki_table_row $script_mediawiki_output "$cipher_name" "$cipher_block_size" "$cipher_key_size" "$cipher_implementation_version" "$cipher_implementation_info" "$cipher_implementation_authors"
			add_xml_table_row $script_xml_output "$cipher_name" "$cipher_block_size" "$cipher_key_size" "$cipher_implementation_version" "$cipher_implementation_info" "$cipher_implementation_authors"
			add_latex_table_row $script_latex_output "$cipher_name" "$cipher_block_size" "$cipher_key_size" "$cipher_implementation_version" "$cipher_implementation_info" "$cipher_implementation_authors"
			add_csv_table_row $script_csv_output "$cipher_name" "$cipher_block_size" "$cipher_key_size" "$cipher_implementation_version" "$cipher_implementation_info" "$cipher_implementation_authors"
			;;
		$SCRIPT_FORMAT_1)
			add_raw_table_row $script_raw_output "$cipher_name" "$cipher_block_size" "$cipher_key_size" "$cipher_implementation_version" "$cipher_implementation_info" "$cipher_implementation_authors"
			;;
