...
static void acorn128_32steps_dec(uint8_t *state, uint8_t *plaintextbyte, const uint8_t *ciphertextbyte, uint8_t cabyte, uint8_t cbbyte)
{
    unsigned int i;
    uint8_t j,f;
    uint8_t byte_12, byte_235, byte_244, byte_23,  byte_160, byte_111, byte_66, byte_196;
...
static void acorn128_8steps_dec(uint8_t *state, uint8_t *plaintextbyte, const uint8_t *ciphertextbyte, uint8_t cabyte, uint8_t cbbyte)
{
    uint8_t j,f;
    uint8_t byte_12, byte_235, byte_244, byte_23,  byte_160, byte_111, byte_66, byte_196;
    uint8_t byte_230,byte_193, byte_154, byte_107, byte_61;
	...
	)
{
    ...
    *mlen = clen - 16;
    ...
    {
        acorn128_32steps_dec(state, &(m[i]), &c[i], ca, cb);
    }

    for (i = *mlen & 0xfffffffffffffffcULL; i < *mlen; i=i+1)
    {
        acorn128_8steps_dec(state, &(m[i]), &c[i], ca, cb);
    }
