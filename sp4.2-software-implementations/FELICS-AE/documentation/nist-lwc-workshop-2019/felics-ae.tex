...
\input{tables/results-128}

Tables~\ref{table:results/128-avr}, \ref{table:results/128-msp},
\ref{table:results/128-arm} and \ref{table:results/128-pc} give
our results on AVR ATmega128, MSP430F1611, ARM Cortex-M3 and x86\_64
PC respectively for \textsc{Lilliput-I-128}, \textsc{Lilliput-II-128},
\textsc{Ascon-128}, \textsc{Ascon-128a} and ACORN.

\subsection{Results for all \textsc{Lilliput-AE} variants}
\label{sec:results/lilliputae}

\input{tables/results-lilliput}

Tables~\ref{table:results/lilliput-avr},
\ref{table:results/lilliput-msp}, \ref{table:results/lilliput-arm} and
\ref{table:results/lilliput-pc} give our results on AVR ATmega128,
MSP430F1611, ARM Cortex-M3 and x86\_64 PC respectively for all
variants of \textsc{Lilliput-AE}.
