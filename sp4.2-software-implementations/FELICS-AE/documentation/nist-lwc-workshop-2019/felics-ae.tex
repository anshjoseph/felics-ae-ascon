...
The framework was initially developed to measure the performance of
block ciphers and stream ciphers.  In the next section, we describe
the changes we made to adapt it to AEAD algorithms.
