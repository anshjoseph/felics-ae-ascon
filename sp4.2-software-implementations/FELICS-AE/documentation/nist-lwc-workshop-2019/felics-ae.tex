...
\item a more complex script which iterates over algorithms,
  architectures, platforms, scenarios, and compiler options, and calls
  on the aforementioned scripts and makefiles to run a comprehensive
  measurement campaign.
\end{itemize}

While adapting FELICS to AEAD algorithms and integrating
\textsc{Lilliput-AE}, \textsc{Ascon} and ACORN, we stumbled on several
issues related to the poor error-reporting capabilities of shell
scripts:
...
TODO: dependencies download script, docker image, instantiation script

\subsubsection{Miscellaneous}
\label{sec:felics-ae/misc}

TODO: key schedule, cycles jitter, scenarios
