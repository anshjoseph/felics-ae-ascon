...
function display_help()
{
	...
	echo " 	./collect_ciphers_metrics.sh [{-h|--help}] [--version] [{-f|--format}=[0|1|2|3|4|5]] [{-a|--architectures}=['PC AVR MSP ARM']] [{-s|--scenarios}=['0 1']] [{-c|--ciphers}=['Cipher1 Cipher2 ...']] [{-p|--prefix}='...'] [{-co|--compiler_options}='...']"
	echo ""
	echo "	Options:"
	echo "		-h, --help"
	...
	echo "		./get_results.sh -a='PC AVR' --scenarios=\"0 1\""
	echo ""
