...
static int32_t ocb_crypt(uint8_t *out, const uint8_t *k, const uint8_t *n,
                     const uint8_t *a, uint32_t abytes,
                     const unsigned char *in, uint32_t inbytes, int32_t encrypting, uint8_t *roundKeys) {
    ...
    hash(ad_hash, k, a, abytes, roundKeys);
