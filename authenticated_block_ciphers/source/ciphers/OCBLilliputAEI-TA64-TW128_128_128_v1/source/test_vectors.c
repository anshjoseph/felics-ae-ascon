...
const uint8_t expectedCiphertext[MAXTEST_BYTES_M + CRYPTO_ABYTES] = {0x8d, 0xb4, 0xe7, 0x1c, 0x17, 0xfa, 0x1b, 0x3f, 0x79, 0x6d, 0x36, 0x15, 0xed, 0x9f, 0x4a, 0x49, 0xbf, 0xaa, 0x82, 0xd4, 0xce, 0x19, 0xab, 0x68};
