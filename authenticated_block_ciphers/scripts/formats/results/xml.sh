...
{	
	...
	case $scenario in
		$SCRIPT_SCENARIO_0)
			...
			printf "\n" >> $output_file
			printf "   <NamedRange ss:Name=\"_FilterDatabase\" ss:RefersTo=\"=Results!R3C1:R3C25\"" >> $output_file
			printf "\n" >> $output_file
			...
			printf "  <Table ss:ExpandedColumnCount=\"25\" x:FullColumns=\"1\"" >> $output_file
			printf "\n" >> $output_file
			...
			printf "\n" >> $output_file
			printf "   <Column ss:Width=\"70.5\"/>" >> $output_file
			printf "\n" >> $output_file
			printf "   <Column ss:Width=\"59.25\"/>" >> $output_file
			printf "\n" >> $output_file
			printf "   <Column ss:Width=\"130.5\"/>" >> $output_file
			printf "\n" >> $output_file
			printf "   <Column ss:Width=\"69\"/>" >> $output_file
			printf "\n" >> $output_file
			printf "   <Column ss:Width=\"57.75\"/>" >> $output_file
			...
			printf "\n" >> $output_file
			printf "   <Column ss:Width=\"61.5\"/>" >> $output_file
			printf "\n" >> $output_file
			...
			printf "\n" >> $output_file
			printf "    <Cell ss:MergeAcross=\"4\" ss:MergeDown=\"1\" ss:StyleID=\"s1\"><Data" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Type=\"String\">Code Size</Data></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">RAM</Data></Cell>" >> $output_file
			printf "\n" >> $output_file
			...
			printf "   <Row>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:Index=\"12\" ss:MergeAcross=\"3\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">Stack</Data></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:MergeAcross=\"5\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">Data</Data></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "   </Row>" >> $output_file
			printf "\n" >> $output_file
			...
			printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">EKS (bytes)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			...
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">DKS (bytes)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">D (bytes)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">EKS + E + DKS + D (bytes)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">EKS (bytes)</Data><NamedCell" >> $output_file
			...
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">EKS (cycles)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			...
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">DKS (cycles)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">D (cycles)</Data><NamedCell" >> $output_file
			printf "\n" >> $output_file
			printf "     ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
			printf "\n" >> $output_file
			printf "   </Row>" >> $output_file
...
function add_xml_table_footer()
{
	...
	printf "\n" >> $output_file
	printf "   <SplitVertical>3</SplitVertical>" >> $output_file
	printf "\n" >> $output_file
	printf "   <LeftColumnRightPane>3</LeftColumnRightPane>" >> $output_file
	printf "\n" >> $output_file
	...
	case $scenario in
		$SCRIPT_SCENARIO_0)
			...
			printf "\n" >> $output_file
			printf "     <RangeSelection>R1C1:R2C3</RangeSelection>" >> $output_file
			printf "\n" >> $output_file
			printf "    </Pane>" >> $output_file
			printf "\n" >> $output_file
			printf "   </Panes>" >> $output_file
			...
			printf "  <AutoFilter x:Range=\"R3C1:R3C25\"" >> $output_file
			printf "\n" >> $output_file
